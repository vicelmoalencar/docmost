...
import { SuggestionManager } from "../suggestion-card/suggestion-manager";
...
export const EditorBubbleMenu: FC<EditorBubbleMenuProps> = (props) => {
  ...
  const suggestionItem: BubbleMenuItem = {
    name: "suggest",
    isActive: () => false,
    command: () => {
      const { from, to } = props.editor.state.selection;
      const selectedText = props.editor.state.doc.textBetween(from, to);
      setShowSuggestionManager(true);
    },
    icon: IconWand,
  };
    ...
    <BubbleMenu {...bubbleMenuProps}>
      <div className={classes.bubbleMenu}>
        ...
        <ActionIcon
          ...
          size="lg"
          radius="0"
          aria-label={suggestionItem.name}
          style={{ border: "none" }}
          onClick={suggestionItem.command}
        >
